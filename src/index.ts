...
const elements: ElementsConfig = {
  alkaliMetals: [
    { id: "lithium", color: "#B6B6E2", ores: { name: "Spodumene", description: "Can be processed into Lithium" } },
    {
      id: "sodium",
      color: "#e1eaff",
    ...
    { id: "potassium", color: "#9DA6EB", ores: { name: "Sylvite", description: "Can be processed into Potassium" } },
    { id: "rubidium", color: "#9A93E5", ores: { name: "Lepidolite", description: "Can be processed into Rubidium" } },
    { id: "caesium", color: "#E8C95A", ores: { name: "Pollucite", description: "Can be processed into Caesium" } },
    { id: "francium", color: "#6732D2" },
  ],
  alkalineEarthMetals: [
    { id: "beryllium", color: "#8CB1DD", ores: { name: "Bertrandite", description: "Can be processed into Beryllium" } },
    { id: "magnesium", color: "#95B8F3", ores: { name: "Magnesite" , description: "Can be processed into Magnesium"} },
    {
      id: "calcium",
      color: "#C4D5EC",
    ...
    { id: "strontium", color: "#A89AE3", ores: { name: "Celestite", description: "Can be processed into Strontium" } },
    { id: "barium", color: "#E0CD77", ores: { name: "Barite", description: "Can be processed into Barium" } },
  ...
  transitionMetals: [
    ...
    },
    {
      id: "vanadium",
      color: "#2a0651",
      ores: { name: "Vanadinite", description: "Can be processed into Vanadium" },
      ingot: { variant: "dark" },
    },
    { id: "chromium", color: "#2B9A32", ores: { name: "Chromite", description: "Can be processed into Chromium" } },
    {
      id: "manganese",
      color: "#6B7076",
      ores: { name: "Pyrolusite", description: "Can be processed into Manganese" },
      ingot: { variant: "light" },
    },
    { id: "nickel", color: "#8A8570", ores: { name: "Pentlandite", description: "Can be processed into Nickel" } },
    {
      id: "zinc",
      color: "#9FA7B0",
    ...
    { id: "yttrium", color: "#7FB4EA", ores: { name: "Xenotime", description: "Can be processed into Yttrium" } },
    { id: "zirconium", color: "#8ABAE6", ores: { name: "Zircon", description: "Can be processed into Zirconium" } },
    { id: "niobium", color: "#3D87C1", ores: { name: "Pyrochlore", description: "Can be processed into Niobium" } },
    { id: "molybdenum", color: "#2D83C8", ores: { name: "Molybdenite", description: "Can be processed into Molybdenum" } },
    ...
    { id: "tantalum", color: "#2C7EB4", ores: { name: "Tantalite", description: "Can be processed into Tantalum" } },
    { id: "tungsten", color: "#503b27", ores: { name: "Wolframite", description: "Can be processed into Tungsten" } },
    { id: "rhenium", color: "#1E568C" },
    { id: "osmium", color: "#1F3F5A" },
    { id: "iridium", color: "#646d7a", ingot: { variant: "light" } },
    { id: "platinum", color: "#D5DBE2", ores: { name: "Ilmenite", description: "Can be processed into Platinum" } },
    {
      id: "mercury",
      color: "#C9CCD1",
      ores: { name: "Cinnabar", color: "#B0120C", description: "Can be processed into Mercury" },
    },
  ...
  postTransitionMetals: [
    ...
    { id: "thallium", color: "#8BAA1D", ores: { name: "Lorandite", description: "Can be processed into Thallium" } },
    ...
    { id: "lead", color: "#44324e", ores: { name: "Galena", description: "Can be processed into Lead" } },
    { id: "flerovium", color: "#2D63A1" },
    { id: "bismuth", color: "#7A667F", ores: { name: "Bismuthinite", description: "Can be processed into Bismuth" } },
    { id: "moscovium", color: "#6A1F93" },
    { id: "polonium", color: "#2D3A47" },
    { id: "livermorium", color: "#7A1F6A" },
  ],
  metalloids: [
    { id: "boron", color: "#1F1F22", ores: { name: "Borax", description: "Can be processed into Boron" } },
    { id: "silicon", color: "#5B616B", ores: { name: "Quartz", description: "Can be processed into Silicon" } },
    { id: "germanium", color: "#3535B0", ores: { name: "Germanite", description: "Can be processed into Germanium" } },
    { id: "arsenic", color: "#4C5056", ores: { name: "Arsenopyrite", description: "Can be processed into Arsenic" } },
    { id: "antimony", color: "#3838AD", ores: { name: "Stibnite", description: "Can be processed into Antimony" } },
    { id: "tellurium", color: "#6A29B4", ores: { name: "Tellurite", description: "Can be processed into Tellurium" } },
  ],
  otherNonmetals: [
    ...
    { id: "phosphorus", color: "#004AA8", ores: { name: "Apatite", description: "Can be processed into Phosphorus" } },
  ...
  actinides: [
    ...
    { id: "uranium", color: "#657148", ores: { name: "Uraninite", description: "Can be processed into Uranium" } },
